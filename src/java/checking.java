...
public class checking extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      try
      {
           ...
           String q1="select prod_name from electronics_tbl order by prod_id";
          ...
          if(request.getParameter("1")!=null)
           {
           q="update electronicitems_tbl set "+x[0]+" =  "+id+" where user='"+user1+"'";
           stmt.addBatch(q);
           }
           if(request.getParameter("2")!=null)
           {
           q="update electronicitems_tbl set "+x[1]+" ="+id+" where user='"+user1+"'";
           stmt.addBatch(q);
           }
          if(request.getParameter("3")!=null)
           {
           q="update electronicitems_tbl set  "+x[2]+"="+id+" where user='"+user1+"'";
           stmt.addBatch(q);
           }
           if(request.getParameter("4")!=null)
           {
           q="update electronicitems_tbl set "+x[3]+" ="+id+" where user='"+user1+"'";
           stmt.addBatch(q);
           }
           if(request.getParameter("5")!=null)  
           {
           q="update electronicitems_tbl set  "+x[4]+"="+id+" where user='"+user1+"'";
           stmt.addBatch(q);
           }
          ...
          if(y[0]!=0)
          {
              ...
              // out.println("<center><h2><a href='home1.jsp'>Visit Again</a></h2></center>");
                getServletContext().getRequestDispatcher("/home1.jsp").forward(request, response);
