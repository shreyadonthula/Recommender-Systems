        ...
        PrintWriter out = response.getWriter();
         try
          ...
          int x1,x2,x3,x4,x5;
           ...
           q="insert into electronicitems_tbl values('"+user+"','"+mobno+"','"+email+"','"+password+"',"+x1+","+x2+","+x3+","+x4+","+x5+")";
          ...
          if(y!=0)
          {
             // out.println("<h2><a href='usrer.jsp'>new</a></h2>");
              // out.println("<h2><a href='cal.jsp?user=<%= user %>'>go</a></h2>");
           
            getServletContext().getRequestDispatcher("/cal.jsp").forward(request, response);
