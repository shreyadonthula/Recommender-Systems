...
<HTML>
    ...
    <table border="1">
        <tr> <td>user</TD> <td>mobno</TD> <td>email</TD> <td>password</TD> <td>HP</TD> <td>ASUS</TD>  <td>DELL</TD> <td>LEN_IDEAPAD</TD> <td>LEN_THINKPAD</TD></tr>
   <%
  try{      
    Class.forName("com.mysql.jdbc.Driver").newInstance();
    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/kits","root","");
    Statement stmt=con.createStatement();
    String strQuery = "select * from electronicitems_tbl";
