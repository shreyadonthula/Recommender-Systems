...
<!DOCTYPE html>
    ...
    <body>
       ...
       <a href="logout.jsp" >&nbsp;&nbsp;&nbsp;&nbsp;logout</a>&nbsp;&nbsp;
        ...
        <%
           ...
           Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/kits","root","");
            q="select * from electronicitems_tbl";
	 ...
	 for(j=0;j<5;j++)
	    ...
	    {	
          ...
          String strQuery2 = "select prod_name from electronics_tbl order by prod_id";
    ...
    Statement stmt1=con.createStatement();
     ...
     p=0;
       String strQuery1 = "select prod_id from electronics_tbl where prod_id ="+(m2[4]+1);
       ResultSet rs2 = stmt2.executeQuery(strQuery1);
       String strQuery = "select prod_id from electronics_tbl where prod_id in ("+(m2[0]+1)+","+(m2[1]+1)+","+(m2[2]+1)+")";
            ResultSet rs1 = stmt1.executeQuery(strQuery);
            %>
            <form method="post" action="checking"><br>
     ...
     while(rs2.next()){
       ...
       <img src="image.jsp?imgid=<%=rs2.getInt(1)%>" width="260" height="350" /> 
     ...
     while(rs1.next()){
       ...
       <input  type="checkbox" name="<%= rs1.getInt(1)%>" value="<%= rs1.getInt(1)%>"><img src="image.jsp?imgid=<%=rs1.getInt(1)%>" width="260" height="350" /> </input>
